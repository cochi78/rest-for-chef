...
require_relative '../../../libraries/abstract_resources/rest_resource'
...
describe "rest_resource using query-based addressing" do
  ...
  it 'should mixin HashHelpers' do
    expect(@provider.class.included_modules).to include(RestSupport::HashHelpers)
  end
